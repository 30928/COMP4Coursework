...
\begin{tiny}
\pythonfile[firstline=262,lastline=344]{./Implementation/Database/MainMenu.py}
\end{tiny}
...
\begin{tiny}
\pythonfile[firstline=239, lastline=239]{./Implementation/Database/MainMenu.py}
\end{tiny}
...
\begin{tiny}
\pythonfile[firstline=243, lastline=255]{./Implementation/Database/MainMenu.py}
\end{tiny}
...
\begin{tiny}
\pythonfile[firstline=326, lastline=326]{./Implementation/Database/MainMenu.py}
\end{tiny}
...
\pythonfile[firstline=491, lastline=491]{./Implementation/Database/MainMenu.py}
...
\pythonfile[firstline=556, lastline=557]{./Implementation/Database/MainMenu.py}
...
\begin{tiny}
\pythonfile[firstline=587, lastline=587]{./Implementation/Database/MainMenu.py}
\end{tiny}
...
\begin{tiny}
\pythonfile[firstline=600, lastline=600]{./Implementation/Database/MainMenu.py}
\end{tiny}
...
\begin{tiny}
\pythonfile[firstline=613, lastline=613]{./Implementation/Database/MainMenu.py}
\end{tiny}
...
\begin{tiny}
\pythonfile[firstline=626, lastline=626]{./Implementation/Database/MainMenu.py}
\end{tiny}
...
\begin{tiny}
\pythonfile[firstline=642, lastline=642]{./Implementation/Database/MainMenu.py}
\end{tiny}
...
\begin{tiny}
\pythonfile[firstline=658, lastline=658]{./Implementation/Database/MainMenu.py}
\end{tiny}
...
\pythonfile[firstline=766, lastline=770]{./Implementation/Database/MainMenu.py}
...
The update string:
\pythonfile[firstline=775, lastline=774]{./Implementation/Database/MainMenu.py}
...
\begin{scriptsize}
\pythonfile[firstline=868, lastline=868]{./Implementation/Database/MainMenu.py}
\end{scriptsize}
...
\begin{tiny}
\pythonfile[firstline=895, lastline=895]{./Implementation/Database/MainMenu.py}
\end{tiny}
...
\pythonfile[firstline=922, lastline=922]{./Implementation/Database/MainMenu.py}
...
\pythonfile[firstline=1]{./Implementation/Database/TableWidget.py} \label{ssec:TableWidget.py}
