...
\begin{tabular}{|p{2cm}|p{2cm}|p{2.5cm}|}
    ...
    Book Invoice ID & Produced by program & \\ \hline
    ...
    Book Invoice Payment & Calculated by program using inputs & Book Invoice Quantity, Book Invoice Discount, Price, Shipping Price \\ \hline
    Royalties Items & Produced by program & \\ \hline
    Book Invoice Items & Produced by program & \\ \hline
\end{tabular}
\end{center}
...
\begin{tabular}{|p{3cm}|p{1cm}|p{2.5cm}|p{1.5cm}|p{2cm}|}
    ...
    BookInvoiceID & Integer & 1-255 & Numbers only & 99 \\ \hline
    BookInvoiceItems & Integer & 1-255 & Numbers only & 2 \\ \hline
...
BookInvoice(\underline{BookInvoiceID}, \emph{AuthorID}, InvoiceDate, InvoicePayment)

BookInvoiceItems(\underline{BookInvoiceItems}, \emph{BookInvoiceID}, \emph{ISBN}, BooksInvoiceQuantity, BooksInvoiceDiscount, ShippingPrice, ShippingType) 
