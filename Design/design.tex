...
\begin{itemize}
    \item Clicking the Add Entry Button will prompt a seperate interface to open, and contains a layout of entry boxes for required fields for entering details about a specific entry type, which could be a new customer, or a book/royalties/royalty items/book invoice/book invoice items/publication invoice, dependent on which has been selected. An existing customer can be selected using the search function, using search criteria that may consist of specific attributes.
    ...
    \item Clicking the Remove Entry Button will prompt a seperate interface to open, which contains a view of the database. Entries can be searched for and then can be selected and deleted.
...
\begin{itemize}
    ...
    \item Once the Search Button is clicked, a list of all the data entries that match the search criteria will come up in a list in the Main Window, in a similar view to the original database.
\end{itemize}

\subsection{System flowcharts showing an overview of the complete system}

The following is a flowchart showing an overview of the complete system.

\begin{figure}[H]
    \caption{Flowchart 1} \label{Flowchart_1.pdf}
    \includegraphics[width=\textwidth]{./Design/Flowchart_1.pdf}
\end{figure}

\begin{figure}[H]
    \caption{Flowchart 2} \label{Flowchart_2.pdf}
    \includegraphics[width=\textwidth]{./Design/Flowchart_2.pdf}
\end{figure}

\begin{figure}[H]
    \caption{Flowchart 3} \label{Flowchart_3.pdf}
    \includegraphics[width=\textwidth]{./Design/Flowchart_3.pdf}
\end{figure}

\begin{figure}[H]
    \caption{Flowchart 4} \label{Flowchart_4.pdf}
    \includegraphics[width=\textwidth]{./Design/Flowchart_4.pdf}
\end{figure}

\begin{figure}[H]
    \caption{Flowchart 5} \label{Flowchart_5.pdf}
    \includegraphics[width=\textwidth]{./Design/Flowchart_5.pdf}
\end{figure}

\begin{figure}[H]
    \caption{Flowchart 6} \label{Flowchart_6.pdf}
    \includegraphics[width=\textwidth]{./Design/Flowchart_6.pdf}
\end{figure}
